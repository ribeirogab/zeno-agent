...
plan: "[[plan-connectors-e2e]]"
spec: "[[spec-connectors-e2e]]"
created: 2026-04-26
---
# Connectors E2E Validation + Testing — Tasks

**For this plan:** `[[plan-connectors-e2e]]`
...
- [ ] Step 1: Update `context/specs/2026-04-26-connectors-e2e/spec.md` frontmatter: `status: shipped`, `shipped: <date>`.
