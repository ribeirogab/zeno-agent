...
2. Open `context/specs/2026-04-26-dashboard-visual-rebuild/STATUS.md` (this file) — current marker
3. Open `context/specs/2026-04-26-dashboard-visual-rebuild/tasks.md` — find next unchecked task
4. Open `context/specs/2026-04-26-dashboard-visual-rebuild/spec.md` + `plan.md` — re-orient
5. Open `context/specs/2026-04-26-dashboard-visual-rebuild/paper-consultations-deferred.md` — items the user will verify against Paper post-merge
