...
spec: "[[spec-zeno-redefinition]]"
created: 2026-04-27
---
# Zeno Redefinition — Plan

**For this spec:** `[[spec-zeno-redefinition]]`
...
| Frontmatter `superseded_by: 0049` references a spec that hasn't shipped yet at the moment of writing. By the time the supersede pass runs (Task 4.1), the spec exists at `context/specs/2026-04-27-zeno-redefinition/spec.md` and is on `main` after this PR merges — so the reference resolves correctly going forward. | **Accepted.** This is a normal forward reference within a single PR. |
