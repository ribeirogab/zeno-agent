...
plan: "[[plan-cron-skills-and-connectors]]"
spec: "[[spec-cron-skills-and-connectors]]"
created: 2026-04-28
---
# Cron ↔ Skills and Connectors — Tasks

**For this plan:** `[[plan-cron-skills-and-connectors]]`
...
- [ ] **G.2.1** Dispatch a `general-purpose` review subagent with the brief: "Review the entire branch diff for spec 0054 against the spec at `context/specs/2026-04-28-cron-skills-and-connectors/spec.md`. Look for: spec drift, missing tests, anti-double-inject correctness, gate-rewrite regressions in interactive flows, audit-log dedup correctness, atomic-replace race windows, dashboard accessibility, copy clarity. Report findings or APPROVED."
