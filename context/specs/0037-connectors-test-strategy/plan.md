...
- `context/specs/0035-connectors-e2e/spec.md` — add header note pointing to spec 0037 as superseder.
...
Update `0035-connectors-e2e/spec.md` header. Add a learning note if anything non-obvious surfaced during Phase 1-7.
