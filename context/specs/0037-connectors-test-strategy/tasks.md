...
> Phase A only. Phase B and Phase C remain deferred and tracked in `0035-connectors-e2e/spec.md` (header pointer added in Phase 9).
...
- [ ] Step 1: Edit `context/specs/0035-connectors-e2e/spec.md` — add a header note: `**Superseded by [[../0037-connectors-test-strategy/spec]]** for the test-infrastructure question. Phases B and C of this spec are extracted on demand.`.
