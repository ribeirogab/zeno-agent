...
10 new artboards in the Paper file `zeno-agent`. PNG snapshots (1× scale) committed to `context/specs/0043-github-app-v2-design/artboards/` with the following filenames:
...
| Paper file evolves and artboard IDs shift | IDs are stable in Paper unless the user manually deletes/recreates. **Mitigation applied:** PNG exports of all 10 artboards committed to `context/specs/0043-github-app-v2-design/artboards/` as a frozen snapshot. Downstream specs (0045/0046) reference these PNGs as fallback if the Paper file diverges. Re-export when iterating. |
...
- This spec.md committed to `context/specs/0043-github-app-v2-design/`.
- 3 clean reviews.
