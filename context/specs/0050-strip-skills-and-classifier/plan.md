...
17. **Specs frontmatter** — `0023-guardrails-approval`, `0028-skill-final-reaction`, `0047-always-sensitive-db-ui` get `status: superseded` + `superseded_by: 0050` + a one-paragraph banner under their frontmatter; bodies untouched.
...
- `context/specs/0023-guardrails-approval/spec.md` — frontmatter + banner.
- `context/specs/0028-skill-final-reaction/spec.md` — frontmatter + banner.
- `context/specs/0047-always-sensitive-db-ui/spec.md` — frontmatter + banner.
