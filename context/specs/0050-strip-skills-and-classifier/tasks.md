...
For each of `context/specs/0023-guardrails-approval/spec.md`, `context/specs/0028-skill-final-reaction/spec.md`, `context/specs/0047-always-sensitive-db-ui/spec.md`:
