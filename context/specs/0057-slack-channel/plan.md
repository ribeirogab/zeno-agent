...
- [ ] All file paths in tasks.md are absolute under `/Users/operator/www/octocat/zeno-agent-worktrees/0057-slack-channel/` OR clearly relative to the worktree root with explicit `cd`.
