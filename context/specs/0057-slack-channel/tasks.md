...
>
> All commands run from the worktree root: `/Users/operator/www/octocat/zeno-agent-worktrees/0057-slack-channel/`. Tests run via `pnpm vitest run <pattern>` from package roots.
...
- [ ] **G.1 R1** — dispatch a fresh review agent:
  ```
  Review the branch feat/spec-0057-slack-channel against main.
...
- [ ] **H.1** Push branch:
  ```bash
  git push -u origin feat/spec-0057-slack-channel
  ```
