...
**Status:** Draft
**Branch:** `feat/spec-0058-fn-cutover-channel` (worktree: `../zeno-agent-worktrees/0058-fn-cutover-channel/`)
...
7. `context/specs/0057-slack-channel/spec.md` — append a single-line errata note: `Update 2026-MM-DD: spec 0058 removed the .env fallback path described in Track 3. The resolution table now has 4 rows, not 6.` Keep the rest of 0057's spec for historical context.
...
- [ ] `context/specs/0057-slack-channel/spec.md` has a 1-line errata note about the resolution table simplification.
