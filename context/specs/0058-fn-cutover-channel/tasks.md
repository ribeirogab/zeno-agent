...
- [ ] **A.2.1** Run quality gate locally from the spec-0057 worktree (PR #22's branch):
  ```bash
  cd /Users/operator/www/octocat/zeno-agent-worktrees/0057-slack-channel
...
- [ ] **H.1.1** From the main repo, switch to the worktree:
  ```bash
  cd /Users/operator/www/octocat/zeno-agent-worktrees/0058-fn-cutover-channel
  git status
  ```
  Expected: on branch `feat/spec-0058-fn-cutover-channel`, clean.
...
- [ ] **H.8.1** Append to `context/specs/0057-slack-channel/spec.md` (just after the frontmatter or at the end of "Open Questions"):
...
- [ ] **H.11.1** Stage + commit:
  ...
  git add apps/worker/src/channels/slack/resolve-credentials.ts \
          ...
          context/specs/0057-slack-channel/spec.md \
          context/specs/0058-fn-cutover-channel/spec.md \
          context/specs/0058-fn-cutover-channel/plan.md \
          context/specs/0058-fn-cutover-channel/tasks.md \
...
- [ ] **J.1.1** Push:
  ```bash
  git push -u origin feat/spec-0058-fn-cutover-channel
  ```
