...
- **Skill listing budget might truncate `fn-code-review`'s description.** The SDK default is 1536 chars per skill description; `fn-code-review`'s description is ~600 chars (verified). Well under the cap. No tuning needed for v1.
