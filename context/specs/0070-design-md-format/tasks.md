...
Working directory: `/Users/operator/www/octocat/zeno-agent-spec-0070` (worktree). Branch: `feat/spec-0070-design-md-format`. Commits use Conventional Commits with `(0070)` scope tag where natural.
...
- [ ] **Step 1: Write the learning**
  ...
  Discovered while writing spec `[[../specs/0070-design-md-format/spec]]`.
...
- [ ] **Step 1: Push branch**
  ...
  ```bash
  cd /Users/operator/www/octocat/zeno-agent-spec-0070
  git push -u origin feat/spec-0070-design-md-format
  ```
...
- [ ] **Step 2: Open the PR**
  ...
  Spec: `context/specs/0070-design-md-format/`.
