...
plan: "[[plan-remote-mcp-runtime]]"
spec: "[[spec-remote-mcp-runtime]]"
created: 2026-04-26
---
# Remote MCP Runtime — Tasks

**For this plan:** `[[plan-remote-mcp-runtime]]`
...
- [ ] Step 4: Update `context/specs/2026-04-26-remote-mcp-runtime/spec.md` frontmatter: `status: shipped`, `shipped: <date>`.
