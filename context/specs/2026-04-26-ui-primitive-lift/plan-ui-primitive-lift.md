...
spec: "[[spec-ui-primitive-lift]]"
created: 2026-04-26
---
# UI Primitive Lift — Implementation Plan

> **For agentic workers:** Steps live in `[[tasks-ui-primitive-lift]]` and use checkbox (`- [ ]`) syntax for tracking. Execute task-by-task; commit after each task closes.
...
**Spec reference:** `[[spec-ui-primitive-lift]]` (`context/specs/2026-04-26-ui-primitive-lift/spec.md`).
