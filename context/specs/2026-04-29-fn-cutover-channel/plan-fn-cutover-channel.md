...
spec: "[[spec-fn-cutover-channel]]"
created: 2026-04-29
---
# Spec 0058 — Migrate `profiles/fn` to channel connector — Plan

**For this spec:** `[[spec-fn-cutover-channel]]`
...
- `context/specs/2026-04-29-fn-cutover-channel/spec.md` — already committed
- `context/specs/2026-04-29-fn-cutover-channel/plan.md` — this file
- `context/specs/2026-04-29-fn-cutover-channel/tasks.md` — the bite-sized task list
...
- `context/specs/2026-04-29-slack-channel/spec.md` — appends 1-line errata note about the resolution table simplification
