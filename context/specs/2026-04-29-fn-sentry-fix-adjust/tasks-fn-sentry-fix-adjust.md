...
plan: "[[plan-fn-sentry-fix-adjust]]"
spec: "[[spec-fn-sentry-fix-adjust]]"
created: 2026-04-29
---
# fn-sentry-fix v2 Adjustments — Tasks

**For this plan:** `[[plan-fn-sentry-fix-adjust]]`
...
- [ ] **E.1.1** Run R1 review covering:
  ...
  - All spec/plan/tasks files in `context/specs/2026-04-29-fn-sentry-fix-adjust/`
