...
plan: "[[plan-slack-zeno-mvp]]"
spec: "[[spec-slack-zeno-mvp]]"
created: 2026-04-15
---
# Zeno MVP — Tasks

**For this plan:** `[[plan-slack-zeno-mvp]]`
...
**Frontmatter:** include `related: ["[[../specs/2026-04-15-slack-zeno-mvp/spec]]"]` so each note backlinks to this spec.
...
Re-read the spec (`[[spec-slack-zeno-mvp]]`) with the findings in hand. Ask: **does any finding invalidate a spec decision or success criterion?**
...
See \`context/specs/2026-04-15-slack-zeno-mvp/\` for the full spec, plan, and task breakdown. Briefly:
...
Edit `context/specs/2026-04-15-slack-zeno-mvp/spec.md` frontmatter:
...
Update `context/_index/specs.md`: move the "2026-04-15-slack-zeno-mvp" bullet from "Active" to "Shipped" with the ship date.

- [ ] **Step 7: Commit**

```bash
git add context/specs/2026-04-15-slack-zeno-mvp/spec.md context/_index/specs.md
