...
plan: "[[plan-ui-primitive-lift]]"
spec: "[[spec-ui-primitive-lift]]"
created: 2026-04-26
---
# UI Primitive Lift — Tasks

**For this plan:** `[[plan-ui-primitive-lift]]`
...
For each item in `[[spec-ui-primitive-lift]]`'s **Success Criteria** section, verify by running the documented check:
